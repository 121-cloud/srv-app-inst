 ...
 */
@IgnoreAuthVerify
public class AppInstStopHandler extends OtoCloudEventHandlerImpl<JsonObject> {
	
	public static final String ADDRESS = "stop";

	public AppInstStopHandler(OtoCloudComponentImpl componentImpl) {
		super(componentImpl);
	}
...
/*		List<ApiParameterDescriptor> paramsDesc = new ArrayList<ApiParameterDescriptor>();
	...
	public void handle(OtoCloudBusMessage<JsonObject> msg) {
		...
		appInstDAO.stopApp(acct_app_id, getFuture);
